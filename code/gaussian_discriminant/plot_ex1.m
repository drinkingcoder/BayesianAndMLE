...
[mmu0,ssigma0] = MLE(X0);
[mmu1,ssigma1] = MLE(X1);
pphi = size(X1,2)/(size(X0,2)+size(X1,2));
disp('Original Phi:');
disp(phi);
disp('Original Distribution of X0:');
disp('Mu:');
disp(mu0);
disp('Sigma:');
disp(Sigma0);
disp('Original Distribution of X1:');
disp('Mu:');
disp(mu1);
disp('Sigma:');
disp(Sigma1);
...
disp('Estimated Phi:');
disp(pphi);
disp('Estimated Distribution of X0:');
disp('Mu:');
disp(mmu0);
disp('Sigma:');
disp(ssigma0);
disp('Estimated Distribution of X1:');
disp('Mu:');
disp(mmu1);
disp('Sigma:');
disp(ssigma1);
